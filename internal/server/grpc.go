...
import (
	...
	"github.com/hoquangnam45/pharmacy-user/internal/service"
...
func NewGRPCServer(c *conf.Server, userService *service.User, healthCheckService *service.HealthCheckService, logger log.Logger) *grpc.Server {
